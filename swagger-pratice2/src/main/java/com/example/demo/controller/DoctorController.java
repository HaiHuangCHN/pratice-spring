...
@Api(tags = {"add/delete/fetch/update information of doctors"})
public class DoctorController {
	...
	@ApiOperation(value = "Add docotor information", notes = "Fail if the doctor can not de found, succeed if found")
